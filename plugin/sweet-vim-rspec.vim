...
function! SweetVimRspecRun(kind,signs)
  ...
  if !exists('g:SweetVimRspecOptions')
    let g:SweetVimRspecOptions = ""
  endif
  ...
  if !exists('t:SweetVimRspecExecutable') || empty(t:SweetVimRspecExecutable)
    ...
    if  t:SweetVimRspecVersion  > 1
      let t:SweetVimRspecExecutable .= "rspec " . g:SweetVimRspecOptions . " -r " . g:SweetVimRspecPlugin . "/sweet_vim_rspec2_formatter.rb" . " -f RSpec::Core::Formatters::SweetVimRspecFormatter "
    else
      let t:SweetVimRspecExecutable .= "spec ". g:SweetVimRspecOptions . " -br " . g:SweetVimRspecPlugin . "/sweet_vim_rspec1_formatter.rb" . " -f Spec::Runner::Formatter::SweetVimRspecFormatter "
    endif
  endif
